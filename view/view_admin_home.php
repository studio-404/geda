		...
		<div class="center">
			<div class="content">
				...
				<div class="shortTable">
					<div id="table">
						<div class="header-row row">
							<span class="cell primary">ShortCuts</span>
							<span class="cell">Action</span>
						</div>
						<!-- <div class="row">
						...
						<div class="row">
							...
							<span class="cell" data-label="Action">
								<a href="<?=WEBSITE.LANG?>/eadmin?action=newsModule&amp;type=newspage&amp;id=31&amp;super=2&amp;token=<?=$_GET['token']?>"><i class="fa fa-pencil-square-o"></i></a>
							</span>
						</div>
						<div class="row">
							<span class="cell primary" data-label="Vehicle">Events</span>
							<span class="cell" data-label="Action">
								<a href="<?=WEBSITE.LANG?>/eadmin?action=newsModule&amp;type=eventpage&amp;id=32&amp;super=2&amp;token=<?=$_GET['token']?>"><i class="fa fa-pencil-square-o"></i></a>
							</span>
						</div>
						<div class="row">
							<span class="cell primary" data-label="Vehicle">Photo Gallery</span>
							<span class="cell" data-label="Action">
								<a href="<?=WEBSITE.LANG?>/eadmin?action=gallery&amp;type=photogallerypage&amp;id=33&amp;super=2&amp;token=<?=$_GET['token']?>"><i class="fa fa-pencil-square-o"></i></a>
							</span>
						</div>
						...
						<div class="row">
							<span class="cell primary" data-label="Vehicle">Components</span>
							<span class="cell" data-label="Action">
								<a href="<?=WEBSITE.LANG?>/eadmin?action=components"><i class="fa fa-pencil-square-o"></i></a>
							</span>
						</div>
					</div>
				</div>
