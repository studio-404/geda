...
<div class="col-sm-12 padding_0" id="message">
</div>
<div class="col-sm-12 padding_0">
<div class="col-sm-5 padding_0">
<div class="form-group">
<input type="text" class="form-control fr-subject" placeholder="<?=$data["language_data"]["contactformsubject"]?>"/>
</div>
</div>	
</div>	
<div class="col-sm-12 padding_0">
<div class="col-sm-5 padding_0">
<div class="form-group">
<input type="text" class="form-control fr-name" placeholder="<?=$data["language_data"]["contactformnamelname"]?>"/>
</div>
</div>	
</div>
<div class="col-sm-12 padding_0">
<div class="col-sm-5 padding_0">
<div class="form-group">
<input type="text" class="form-control fr-email" placeholder="<?=$data["language_data"]["contactformemail"]?>"/>
</div>
</div>	
</div>
<div class="col-sm-12 padding_0"> 
<div class="form-group">
<textarea class="form-control fr-message"></textarea>
</div> 
</div>
<div class="col-sm-12 padding_0">
<div class="text-right">		
<button class="btn btn-yellow fr-button" data-lang="<?=LANG?>"><?=$data["language_data"]["contactformbutton"]?></button>
</div>
</div> 
</div>	 
<?php
