	...
	public function table($c,$sql,$exe_array){
		...
		try{ 
			...
			while($rows = $query->fetch()){
				...
				$out .= '<a href="javascript:;" onclick="copyMe(\'hiddenIframe'.$x.'\')" title="copy chart code"><i class="fa fa-files-o"></i></a>';
				$out .= '<a href="#" title="Edit chart"><i class="fa fa-pencil-square-o"></i></a>';
